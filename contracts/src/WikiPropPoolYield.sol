...
contract WikiPropPoolYield is ReentrancyGuard, Ownable2Step {
    ...
    event YieldDeployed(uint256 aaveAmount, uint256 lendingAmount, uint256 timestamp);
    event YieldRecalled(uint256 aaveAmount, uint256 lendingAmount, string reason);
