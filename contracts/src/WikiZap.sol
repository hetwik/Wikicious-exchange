...
contract WikiZap is Ownable2Step, ReentrancyGuard, Pausable {
    ...
    event Zapped(address indexed user, address tokenIn, uint256 amountIn, uint256 poolId, uint256 lpReceived, uint256 fee);
    event ZappedToVault(address indexed user, address tokenIn, uint256 amountIn, uint256 sharesReceived, uint256 fee);
