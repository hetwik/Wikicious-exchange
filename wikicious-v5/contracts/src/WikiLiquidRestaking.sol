 ...
 *
 * Note: Arbitrum does not natively support EigenLayer. This contract bridges
...
contract WikiLiquidRestaking is ERC20, Ownable2Step, ReentrancyGuard {
    ...
    event Deposited(address indexed user, address token, uint256 amount, uint256 wLRTMinted);
    event Withdrawn(address indexed user, address token, uint256 amount, uint256 wLRTBurned);
